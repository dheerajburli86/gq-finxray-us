...
# Keep the old price/volume proxy logic, just make it honest
new_content = '''"""
...
open('etf_flow_poller.py', 'w').write(new_content)
print('✓ Reverted Feature 7 to proxy signals (honest, works with current plan)')
